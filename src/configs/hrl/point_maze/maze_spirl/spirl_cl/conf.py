...
from src.policies.cl_model_policies import ACClModelPolicy
from src.agents.specific.maze_agents import MazeACActionPriorSACAgent
...
ll_policy_params = AttrDict(
    ...
    policy_model_checkpoint=os.path.join(os.environ["EXP_DIR"], "skill/point_maze/hierarchical_cl"),
