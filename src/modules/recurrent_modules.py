...
from src.modules.layers import BaseProcessingNet, FCBlock
from src.modules.losses import L2Loss
from src.modules.variational_inference import stack
from src.utils.general_utils import batchwise_assign, map_dict, \
...
class MLPLSTMCellInitializer(LSTMCellInitializer):
    ...
    def __init__(self, hp, cell, input_sz):
        ...
        from src.modules.subnetworks import Predictor    # to avoid cyclic import
